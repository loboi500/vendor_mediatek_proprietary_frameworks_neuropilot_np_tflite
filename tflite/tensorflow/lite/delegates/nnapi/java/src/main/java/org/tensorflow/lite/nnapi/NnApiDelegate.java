...
public class NnApiDelegate implements Delegate, AutoCloseable {
  ...
  public static final class Options {
    ...
    private Boolean useNnapiCpu = true;
    private Boolean allowFp16 = null;

    private int executionPriority = EXECUTION_PRIORITY_MEDIUM;
    private long maxCompilationTimeoutDurationNs;
    private long maxExecutionTimeoutDurationNs;
    private long maxExecutionLoopTimeoutDurationNs;
  }
  ...
  public NnApiDelegate(Options options) {
    ...
    delegateHandle =
        createDelegate(
            ...
            options.maxCompilationTimeoutDurationNs,
            options.maxExecutionTimeoutDurationNs,
            options.maxExecutionLoopTimeoutDurationNs);
  }
