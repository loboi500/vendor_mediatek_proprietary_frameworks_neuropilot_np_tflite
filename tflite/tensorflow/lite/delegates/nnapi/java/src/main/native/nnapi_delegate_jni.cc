...
Java_com_mediatek_neuropilot_1S_nnapi_NnApiDelegate_createDelegate(
    ...
    jboolean allow_fp16, jint execution_priority, jlong max_compilation_timeout_duration_ns,
    jlong max_execution_timeout_duration_ns, jlong max_execution_loop_timeout_duration_ns) {
  ...
  options.execution_priority = static_cast<int>(execution_priority);
  options.max_compilation_timeout_duration_ns  =
    static_cast<uint64_t>(max_compilation_timeout_duration_ns);
  options.max_execution_timeout_duration_ns =
    static_cast<uint64_t>(max_execution_timeout_duration_ns);
  options.max_execution_loop_timeout_duration_ns =
    static_cast<uint64_t>(max_execution_loop_timeout_duration_ns);
...
Java_com_mediatek_neuropilot_1S_nnapi_NnApiDelegate_getNnapiErrno(JNIEnv* env,
                                                           jclass clazz,
                                                           jlong delegate) {
...
Java_com_mediatek_neuropilot_1S_nnapi_NnApiDelegate_deleteDelegate(JNIEnv* env,
                                                            jclass clazz,
                                                            jlong delegate) {
