...
#define LOG_TAG "MtkExtTransposeConv2d"
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  ...
  TF_LITE_ENSURE_EQ(context, SizeOfDimension(input, 3), SizeOfDimension(filter, 3));
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  context->ReportError(context, "MTKEXT_TRANSPOSE_CONV_2D operator is not implemented.\n");
  return kTfLiteError;
}
...
int32_t add_neuron_params(NeuronModel* nn_model,
  ...
  auto builtin = reinterpret_cast<ops::mtkext::transpose_conv_2d::OpData*>(data);
...
TfLiteRegistration* Register_MTKEXT_TRANSPOSE_CONV_2D() {
  static TfLiteRegistration r = {transpose_conv_2d::Init,
                                 transpose_conv_2d::Free,
                                 transpose_conv_2d::Prepare,
                                 transpose_conv_2d::Eval};
  ::tflite::mtk::CustomOpHelper::GetInstance().SetMtkExtOpParameterFuncNeuron(
      "MTKEXT_TRANSPOSE_CONV_2D", transpose_conv_2d::add_neuron_params);
  ::tflite::mtk::CustomOpHelper::GetInstance().SetMtkExtOpParameterFunc(
      "MTKEXT_TRANSPOSE_CONV_2D", transpose_conv_2d::add_ann_params);
