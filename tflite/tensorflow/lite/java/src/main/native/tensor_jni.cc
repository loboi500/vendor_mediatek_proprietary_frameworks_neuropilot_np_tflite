...
JNIEXPORT jlong JNICALL Java_com_mediatek_neuropilot_1S_Tensor_create(
...
JNIEXPORT void JNICALL Java_com_mediatek_neuropilot_1S_Tensor_delete(JNIEnv* env,
                                                              jclass clazz,
                                                              jlong handle) {
  delete reinterpret_cast<TensorHandle*>(handle);
}

JNIEXPORT jobject JNICALL Java_com_mediatek_neuropilot_1S_Tensor_buffer(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
...
JNIEXPORT void JNICALL Java_com_mediatek_neuropilot_1S_Tensor_writeDirectBuffer(
...
Java_com_mediatek_neuropilot_1S_Tensor_readMultiDimensionalArray(JNIEnv* env,
                                                          jclass clazz,
                                                          jlong handle,
                                                          jobject value) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT void JNICALL
Java_com_mediatek_neuropilot_1S_Tensor_writeMultiDimensionalArray(JNIEnv* env,
                                                           jclass clazz,
                                                           jlong handle,
                                                           jobject src) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT void JNICALL Java_com_mediatek_neuropilot_1S_Tensor_writeScalar(
    JNIEnv* env, jclass clazz, jlong handle, jobject src) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) return;
  if ((tensor->type != kTfLiteString) && (tensor->data.raw == nullptr)) {
...
JNIEXPORT jint JNICALL Java_com_mediatek_neuropilot_1S_Tensor_dtype(JNIEnv* env,
                                                             jclass clazz,
                                                             jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT jstring JNICALL Java_com_mediatek_neuropilot_1S_Tensor_name(JNIEnv* env,
                                                               jclass clazz,
                                                               jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) {
...
Java_com_mediatek_neuropilot_1S_Tensor_shape(JNIEnv* env, jclass clazz, jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) return nullptr;
  int num_dims = tensor->dims->size;
...
JNIEXPORT jintArray JNICALL Java_com_mediatek_neuropilot_1S_Tensor_shapeSignature(
...
JNIEXPORT jint JNICALL Java_com_mediatek_neuropilot_1S_Tensor_numBytes(JNIEnv* env,
                                                                jclass clazz,
                                                                jlong handle) {
...
Java_com_mediatek_neuropilot_1S_Tensor_hasDelegateBufferHandle(JNIEnv* env,
                                                        jclass clazz,
                                                        jlong handle) {
  const TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT jint JNICALL Java_com_mediatek_neuropilot_1S_Tensor_index(JNIEnv* env,
                                                             jclass clazz,
                                                             jlong handle) {
  return GetTensorIndexFromHandle(env, handle);
}

JNIEXPORT jfloat JNICALL Java_com_mediatek_neuropilot_1S_Tensor_quantizationScale(
    JNIEnv* env, jclass clazz, jlong handle) {
  const TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  return static_cast<jfloat>(tensor ? tensor->params.scale : 0.f);
}

JNIEXPORT jint JNICALL Java_com_mediatek_neuropilot_1S_Tensor_quantizationZeroPoint(
    JNIEnv* env, jclass clazz, jlong handle) {
  const TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
