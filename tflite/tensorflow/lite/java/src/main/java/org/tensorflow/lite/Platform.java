...
public final class Platform {
  private static final String LIBNAME = "tensorflowlite_jni_mtk";
  ...
  private static String getCpuName() {
    ...
    try {
      String value = "";
      try {
        Process ifc = Runtime.getRuntime().exec("getprop ro.soc.model");
  ...
  private static boolean isMtkPlatform() {
    ...
    if (cpuName.toLowerCase().contains("qualcomm")) {
      return false;
    }
    Pattern p = Pattern.compile("m(t|)[0-9][0-9][0-9][0-9].*");
